...
import { BookingFormData } from "./forms/booking-form/booking-form";
...
export const fetMyHotelById = async (hotelId: string): Promise<HotelType> => {
...
export const createBooking = async (formData: BookingFormData) => {
  const resposne = await fetch(`${API_BASE_URL}/api/hotels/${formData.hotelId}/bookings`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
